...
public:
    ...
    void rk4_adjoint(const std::array<double,n_int_grid_points> &psi_n_plus,
                     const std::array<double,n_int_grid_points> &jun_wn, 
                     std::array<double,n_int_grid_points> &psi_n);
    
    void rk4_adjoint(const std::array<std::array<double,n_subspace_vectors>,n_int_grid_points> &psi_n_plus,
                     const std::array<double,n_int_grid_points> &jun_wn, 
